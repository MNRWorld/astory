  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      toast({
        ...
        description: "আপনাকে হোমপেজে নিয়ে যাওয়া হচ্ছে...",
      });
      navigate("/");
    } catch (error: any) {
      toast({
    ...
    <div className="flex min-h-screen items-center justify-center bg-secondary/50 p-4">
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          ...
          <Button
            type="button"
            className="mb-4 w-full justify-start gap-3 bg-primary hover:bg-primary/90"
            onClick={startMnrIdLogin}
          >
          ...
          <div className="relative mb-4 flex items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground">অথবা username দিয়ে</span>
            <Separator className="flex-1" />
          </div>
